...
$q = "SELECT image_id,id,image,title,a,category FROM images WHERE approved=1";
...
$data = '<html>
            ...
            <body>
                <div class="wrapper">
                <h1 style="text-align:center; padding: 30px 25px;"> DISSAPPROVE OR DELETE LIVE IMAGES </h1>
...
while ($row = $result->fetch_assoc()) {
      ...
      $data .= '
                <tr>
                    ...
                    <td>'.$name2.'</td>
                    <td><a href="disapprove-image.php?id='.$row["image_id"].'">DISAPPROVE</a> </td>
